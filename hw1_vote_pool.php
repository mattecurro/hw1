...
<html>
    <head>
        <script src="hw1_vote_pool.js" defer></script>
    ...
    <body>
            ...
            <input type="hidden" name="id" value=<?php echo $sondaggio['Id'] ?> >
            <input type="hidden" name="n_vot" value=<?php echo $sondaggio['N_Votanti'] ?> >
